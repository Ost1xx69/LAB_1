...
public class Main {
    public static void main(String[] args) {
        ...
        User user1 = new User(1, 19, "Ost1xx", "Opel", 71.5, 173.0);
        User user2 = new User(2, 19, "V1tal9", "Ventana", 62.0, 174.0);
        User user3 = new User(3, 19, "Andriyy", "High", 87.0, 181.0);
        User user4 = new User(4, 18, "ТTaras", "Drusch", 55.5, 162.0);
        User user5 = new User(5, 19, "Bodya", "Passat", 65.0, 171.0);
        User user6 = new User(6, 18, "YURIY", "Bokser", 72.0, 188.0);
        User user7 = new User(7, 19, "Andriyy ", "Rolex", 53.0, 156.0);
        User user8 = new User(8, 18, "Nazar", "Levkuts", 70.0, 174.0);
        User user9 = new User(9, 18, "Kyrylo", "Ivanyshyn", 60.0, 161.0);
        User user10 = new User(10, 19, "Andriy", "Valylo", 88.0, 181.0);
